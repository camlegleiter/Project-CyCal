...
{
document.getElementById("usernametxtbox").innerHTML="";
}
</script>
					...
					<table cellspacing="10px" cellpadding="10px">
						...
						<tr>
							...
							<td>
								...
								<input type='text' id="textbox" name='user' onFocus="if(this.value=='Username')this.value='';" onblur="if(this.value == ''){ this.value = 'Username';}" value="Username">
						...
						<tr>
							...
							<td>
								...
								<input type='password' id="textbox" name='pass' onFocus="if(this.value=='Password')this.value='';" onblur="if(this.value == ''){ this.value = 'Password';}" value="Password">
